...
<head>
    ...
    <title>Kpler Growth Marketing Story Points Calculator</title>
...
<body>
    <div class="container">
        <div class="calculator-container">
            ...
            <!-- Important: Added onsubmit="return false;" to prevent form submission -->
            <form id="calculatorForm" onsubmit="return false;">
                ...
                <!-- Changed to type="button" instead of type="submit" -->
                <button type="button" id="calculateButton" class="btn btn-primary w-100">Calculate Story Points</button>
            </form>
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Quick copy updates for website, simple social media post</td>
                                    </tr>
                                    <tr>
                                        <td>2</td>
                                        ...
                                        <td>Adding a CTA button, simple email setup, basic keyword research</td>
                                    </tr>
                                    <tr>
                                        <td>3</td>
                                        <td>Medium (1 day)</td>
                                        ...
                                        <td>Creating a basic landing page, setting up a simple campaign, content for a blog post</td>
                                    </tr>
                                    <tr>
                                        <td>5</td>
                                        ...
                                        <td>New email nurture flow, complex landing page, audience segmentation strategy</td>
                                    </tr>
                                    <tr>
                                        <td>8</td>
                                        ...
                                        <td>Marketing automation workflow, comprehensive campaign planning, conversion optimization project</td>
                                    </tr>
                                    <tr>
                                        <td>13</td>
                                        ...
                                        <td>New marketing platform integration, major product launch campaign, complete funnel redesign</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
